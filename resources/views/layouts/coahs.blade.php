                ...
                <ul class="sidebar-nav-menu">
                    ...
                    <li class="sidebar-nav-item has-submenu">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><a href="{{ route('admin.equipment.index') }}" class="sidebar-submenu-link"><i class="fas fa-tools"></i><span>Equipments</span></a></li>
                            ...
                            <li><a href="{{ route('admin.supplies.index') }}" class="sidebar-submenu-link"><i class="fas fa-syringe"></i><span>Supplies</span></a></li>
                            <li><a href="{{ route('admin.borrowers.index') }}" class="sidebar-submenu-link"><i class="fas fa-wrench"></i><span>Borrowers</span></a></li>
                        </ul>
                    </li>
                    <li class="sidebar-nav-item">
